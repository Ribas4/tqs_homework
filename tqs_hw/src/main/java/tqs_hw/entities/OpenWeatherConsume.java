package tqs_hw.entities;

import tqs_hw.App;
import tqs_hw.repository.WeatherRepo;
...
public class OpenWeatherConsume {
  ...
  private static final String ACCESS_KEY = "131ab9110a93c2332116b5f01bd2cf3a";
  ...
  public List<WeatherEntity> sendRequestForWeatherInfo(String city) {
    ...
    List<WeatherEntity> reportWeather = new ArrayList<WeatherEntity>();
    HttpUriRequest get =
        RequestBuilder.get()
